...
class BodyGameRuntime(object):
    ...
    def update_fps(self):
        ...
        #if:
        if round(self.pred*100,2) < 40:
            fps = "Your score : " + str(round(self.pred*100,2))
            fps_text = self.font.render(fps, 1, pygame.Color("red"))
        elif  exercise_name == 'Kimore ex2' and round(self.pred*100,2) > 40:
            if round(self.pred*100,2) + 30 <90:
                fps = "Your score : " + str(round(self.pred*100,2) + 30)
                fps_text = self.font.render(fps, 1, pygame.Color("green"))
            else:
                fps = "Your score : " + str(round(self.pred*100,2))
                fps_text = self.font.render(fps, 1, pygame.Color("green"))
        elif  exercise_name == 'Kimore ex3' and round(self.pred*100,2) > 40:
            if round(self.pred*100,2) + 20 <90:
                fps = "Your score : " + str(round(self.pred*100,2) + 30)
                fps_text = self.font.render(fps, 1, pygame.Color("green"))
            else:
                fps = "Your score : " + str(round(self.pred*100,2))
                fps_text = self.font.render(fps, 1, pygame.Color("green"))
            # fps = "Your score : " + str(round(self.pred*100,2) + 20)
            # fps_text = self.font.render(fps, 1, pygame.Color("green"))
        else:
            fps = "Your score : " + str(round(self.pred*100,2))
            fps_text = self.font.render(fps, 1, pygame.Color("green"))
    ...
    def ex_name(self):
        #fps = str(int(self.clock.get_fps()))
        if exercise_name == 'Kimore ex1':
            if round(self.pred*100,2) < 40:
                #fps ="Exercise: Squating"
                fps ="Exercise: Lifting of the arms"
                fps_text = self.font.render(fps, 1, pygame.Color("red"))
            elif round(self.pred*100,2) > 40:
                fps ="Exercise: Lifting of the arms"
                fps_text = self.font.render(fps, 1, pygame.Color("green"))
        elif exercise_name == 'Kimore ex2':
            if round(self.pred*100,2) < 40:
                #fps ="Exercise: Squating"
                fps ="Exercise: Lateral tilt"
                fps_text = self.font.render(fps, 1, pygame.Color("red"))
            elif round(self.pred*100,2) > 40:
                fps ="Exercise: Lateral tilt"
                fps_text = self.font.render(fps, 1, pygame.Color("green"))
            
        elif exercise_name == 'Kimore ex3':
            if round(self.pred*100,2) < 40:
                #fps ="Exercise: Squating"
                fps ="Exercise: Trunk rotation"
                fps_text = self.font.render(fps, 1, pygame.Color("red"))
            elif round(self.pred*100,2) > 40:
                fps ="Exercise: Trunk rotation"
                fps_text = self.font.render(fps, 1, pygame.Color("green"))
            
        elif exercise_name == 'Kimore ex4':
            if round(self.pred*100,2) < 40:
                #fps ="Exercise: Squating"
                fps ="Exercise: Pelvis rotations"
                fps_text = self.font.render(fps, 1, pygame.Color("red"))
            elif round(self.pred*100,2) > 40:
                fps ="Exercise: Pelvis rotations"
                fps_text = self.font.render(fps, 1, pygame.Color("green"))
        elif exercise_name == 'Kimore ex5':
            if round(self.pred*100,2) < 40:
                fps ="Exercise: Squating"
                #fps =" Lateral tilt"
                fps_text = self.font.render(fps, 1, pygame.Color("red"))
...
exercise_name = 'Kimore ex5'
folder_name = 'best model_1/'
weight_filename = folder_name + exercise_name + '.hdf5'
#weight_filename = 'best model_1/Kimore ex3(2).hdf5'

data_loader = Data_Loader(exercise_name)
